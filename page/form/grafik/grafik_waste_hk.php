	...
	<div class="row mb-2">
	  ...
	  <div class="col-sm-6">
		<ol class="breadcrumb float-sm-right">
		  ...
		  <li class="breadcrumb-item active">Grafik Waste HK Viewer</li>
		</ol>
	  </div><!-- /.col -->
	</div><!-- /.row -->
  </div><!-- /.container-fluid -->
			...
			<div class="col-md-12">
				...
				<div class="card card-success">
				  <div class="card-header">
					<h3 class="card-title">Grafik Waste HK Viewer</h3>
				  </div>
				  <!-- /.card-header -->
				  <!-- form start -->
				  <form action="?page=detail_grafik_waste_hk" method="post">
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
					...
					<div class="card-footer">
					  <button type="submit" class="btn btn-success">Generate Grafik Waste HK</button>
					</div>
				  </form>
				</div>
			</div>
