		 ...
		 <div class="card-header">
		  ...
		  <div class="row">
			<div class="col-md-12" id="divToConvert">
				...
				<div class="card">
					<div class="card-header">
						<h5 style="text-align:center">Resume Form SP</h5>
					...
					foreach ($data as $item) {
						...
						if ($tanggal >= $startDate && $tanggal <= $endDate) {
							if (
								...
								/**
								$pasal = explode("-",$item["pasal_pkb"]);
								$pasal_pkb = $pasal[0];
								$jenisPelanggaran = $pasal_pkb;
								**/
								$jenisPelanggaran = $item["perihal_sp"];
...
Highcharts.chart('pie', {
    ...
    title: {
        text: 'Sebaran Data Surat Peringatan',
        align: 'left',
		style: {
