	...
	<div class="row mb-2">
	  ...
	  <div class="col-sm-6">
		<ol class="breadcrumb float-sm-right">
		  ...
		  <li class="breadcrumb-item active">Grafik Reject Mesin Viewer</li>
		</ol>
	  </div><!-- /.col -->
	</div><!-- /.row -->
  </div><!-- /.container-fluid -->
			...
			<div class="col-md-12">
				...
				<div class="card card-success">
				  <div class="card-header">
					<h3 class="card-title">Grafik Reject Mesin Viewer</h3>
				  </div>
				  <!-- /.card-header -->
				  <!-- form start -->
				  <form action="?page=detail_grafik_reject_mesin" method="post">
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
					...
					<div class="card-footer">
					  <button type="submit" class="btn btn-success">Generate Grafik Reject Mesin</button>
					</div>
				  </form>
				</div>
			</div>
