...
<div class="content-header">
  <div class="container">
	<div class="row mb-2">
	  <div class="col-sm-6">
		<h1 class="m-0">  <small>Data Viewer </small></h1>
	  </div><!-- /.col -->
	  <div class="col-sm-6">
		<ol class="breadcrumb float-sm-right">
		  <li class="breadcrumb-item"><a href="#">Home</a></li>
		  <li class="breadcrumb-item active">Data Viewer</li>
		</ol>
	  </div><!-- /.col -->
	</div><!-- /.row -->
  </div><!-- /.container-fluid -->
			...
			<div class="col-md-12">
				...
				<div class="card card-success">
				  <div class="card-header">
					<h3 class="card-title">Data Viewer</h3>
				  </div>
				  <!-- /.card-header -->
				  <!-- form start -->
				  <form action="?page=detail_report" method="post">
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
								  ...
								  <div class="form-group">
									...
									<select class="form-control select2bs4" name="nama_form" required>									  
										<?php
											session_start();
											echo $departemen = $_SESSION['departemen'];
											if($departemen == 'utility'){
												$selectForm = pg_query($conn, "SELECT * FROM tbl_form WHERE departemen='$departemen'");
											}else if($departemen == 'qc'){
												$selectForm = pg_query($conn, "SELECT * FROM tbl_form WHERE departemen='$departemen'");
											}
											
											else{
												$selectForm = pg_query($conn, "SELECT * FROM tbl_form");
											}
											
											while ($listForm = pg_fetch_array($selectForm)) {
											?>
											<option value="<?= $listForm['kode_form'] ?>"><?= $listForm['nama_form'] ?></option>
										<?php
										}
										?>
									</select>
